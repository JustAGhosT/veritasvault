...
§3, for the Muniment go-to-market it is a **present-tense blocker**, and it is the highest-severity
...
|            | Muniment deck                                                                                                                                                                                                        | Corporate deck                                                                                             |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| Execution  | "Muniment recommends; it does not trade on your behalf. Execution stays your decision **by design**, and automated rebalancing is **deliberately out of scope** for the private-client product rather than pending." | "Automated rebalancing with institutional controls" (Roadmap); "Threshold-triggered rebalancing" (Roadmap) |
...
The Muniment deck closes with:

> "Muniment is a portfolio analysis and allocation tool provided by VeritasVault. It does not provide
...
problem.** The Muniment deck sells a small early cohort with direct founder access. In those
...
Muniment is more likely than not to constitute the furnishing of advice in respect of a financial
...
the perimeter — meaning Muniment can plausibly serve UK clients without FCA authorisation. That is a
...
| SA-10 | **POPIA — direct marketing**                          | Y                                             | POPIA s69; Information Regulator Guidance Note on Direct Marketing (Dec 2024) | Unsolicited electronic direct marketing requires prior consent unless the recipient is an existing customer; consent must be requested in the prescribed manner and form; existing-customer marketing is limited to similar products with a right to object. **The Muniment GTM is founder-led outreach to private investors — this provision governs it directly.** See §7.1 item B4.                                                                                                |
...
| ------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------- | ----------------------------------- |
| **A1** | **Obtain a written perimeter opinion from SA counsel** on whether Muniment as designed constitutes furnishing advice under FAIS. Everything else branches off this answer.                                                                                                                                                                                                                                                             | Founder + SA counsel | 2–4 weeks                           |
...
1. Does the Muniment product as described — ingesting a client's actual holdings, taking their stated
...
2. Does the disclaimer in the Muniment deck have any perimeter effect at all, or is it purely a
...
9. **Does the s21 financial promotion regime capture the promotion of a portfolio-analysis tool for
   ...
   the operative question for the public website and the Muniment deck, and it is live today.
...
12. Is the Muniment early cohort a customer prepayment or an offer of securities? If the latter, which
